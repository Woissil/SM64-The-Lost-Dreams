...
const LevelScript local_area_bowser_3_1_[] = {
	...
	TERRAIN(col_bowser_3_1_0xe00b100),
...
const LevelScript local_objects_bowser_3_1_[] = {
	OBJECT_WITH_ACTS(0, 0, 1039, 0, 0, 180, 0, 0xa0000,  bhvSpinAirborneWarp, 31),
	OBJECT_WITH_ACTS(100, 0, 0, -1398, 0, 0, 0, 0x0,  bhvBowser, 31),
	OBJECT_WITH_ACTS(101, -7, 0, -4213, 0, 0, 0, 0x0,  bhvBowserBomb, 31),
	OBJECT_WITH_ACTS(101, -3592, 0, 2098, 0, 30, 0, 0x0,  bhvBowserBomb, 31),
	OBJECT_WITH_ACTS(101, 3632, 0, 2052, 0, 60, 0, 0x0,  bhvBowserBomb, 31),
	OBJECT_WITH_ACTS(0, 1869, 424, -1177, 0, 0, 0, 0x0,  bhvWaterBombSpawner, 31),
	OBJECT_WITH_ACTS(0, 1017, 424, 621, 0, 0, 0, 0x0,  bhvWaterBombSpawner, 31),
	OBJECT_WITH_ACTS(0, 17, 424, -1184, 0, 0, 0, 0x0,  bhvWaterBombSpawner, 31),
	OBJECT_WITH_ACTS(0, 51, 424, 2083, 0, 0, 0, 0x0,  bhvWaterBombSpawner, 31),
	OBJECT_WITH_ACTS(0, -1202, 424, 575, 0, 0, 0, 0x0,  bhvWaterBombSpawner, 31),
	OBJECT_WITH_ACTS(0, -1906, 424, -1181, 0, 0, 0, 0x0,  bhvWaterBombSpawner, 31),
	OBJECT_WITH_ACTS(22, -2142, 88, -767, 0, 78, 0, 0x0,  bhvBoo, 31),
	OBJECT_WITH_ACTS(22, -1512, 88, 1243, 0, 142, 0, 0x0,  bhvBoo, 31),
	OBJECT_WITH_ACTS(22, 103, 88, 2081, 0, 180, 0, 0x0,  bhvBoo, 31),
	OBJECT_WITH_ACTS(22, 1671, 88, 1482, 0, 232, 0, 0x0,  bhvBoo, 31),
	OBJECT_WITH_ACTS(22, 2142, 88, -839, 0, 287, 0, 0x0,  bhvBoo, 31),
	OBJECT_WITH_ACTS(22, 0, 144, -2267, 0, 0, 0, 0x0,  bhvBoo, 31),
	//OBJECT_WITH_ACTS(46, 0, 1039, 0, 0, 0, 0, 0x10000,  bhvCheckpoint_Flag_MOP, 31),
	//OBJECT_WITH_ACTS(0, 4, 5, 339, 0, 0, 0, 0,  editor_Scroll_Texture, 31),
	//OBJECT_WITH_ACTS(0, 4, 5, 249, 0, 0, 0, 1,  editor_Scroll_Texture, 31),
	//OBJECT_WITH_ACTS(0, 4, 5, 381, 9, 0, 0, 2,  editor_Scroll_Texture, 31),
	//OBJECT_WITH_ACTS(0, 4, 5, 381, 9, 0, 0, 3,  editor_Scroll_Texture, 31),
	RETURN()
};
...
const LevelScript local_warps_bowser_3_1_[] = {
	...
	WARP_NODE(241, 21, 1, 69, 0),
	WARP_NODE(8, 10, 1, 10, 0),
	WARP_NODE(0, 10, 1, 10, 0),
	WARP_NODE(0, 10, 1, 10, 0),
	WARP_NODE(0, 10, 1, 10, 0),
	WARP_NODE(0, 10, 1, 10, 0),
